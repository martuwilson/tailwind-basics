...
const Navbar = () => {
  return (
    <>
       <div id='header' className='h-20 bg-black text-white bebas'>
        <div className='container w-11/12 mx-auto flex flex-row'>
            ...
            <nav className='flex-1'>
                <ul className='flex flex-row h-20 items-center justify-end text-2xl text-center mr-6'>
